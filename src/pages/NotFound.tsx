...
function NotFound(): React.JSX.Element {
  return (
    <section className="flex min-h-[60vh] flex-col items-center justify-center bg-dark px-6 py-24 text-center">
      <p className="text-8xl font-bold text-white/40">404</p>
      <h1 className="mt-4 text-2xl font-bold tracking-wide text-white">Page Not Found</h1>
